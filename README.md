...
The Smart Health Monitoring and Emergency Assistance system developed using the **LPC2129 (ARM7)** microcontroller. The project continuously monitors vital health parameters such as **Heart Rate**, **SpO2**, **Body Temperature**, and **Saline level**, displays them on an LCD and serial port using UART.
...
- Bluetooth connectivity for monitoring the patient condition time to time
...
├── temparature.c       # DHT11 temperature sensor driver
├── saline_level.c      # Ultrasonic sensor driver
...
7. Sends sensor data through UART/Bluetooth for monitoring.
...
---
## Contributors
- E. Naveen Kumar Reddy (@enaveenredy18)